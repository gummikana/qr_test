...
int main(int argc, char *argv[])
{
...

	{
		...
		*/
		...
		// poro::RunPoro< LuaUITest >(appconf);
		poro::RunPoro< QRTest >(appconf);
		// poro::RunPoro< NoMoreMeat >(appconf);
	}
